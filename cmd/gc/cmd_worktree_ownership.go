...
// addWorktreeOwnershipCommands preserves the transactional ensure, verify, and
// cleanup surface alongside the publication lifecycle commands.
func addWorktreeOwnershipCommands(cmd *cobra.Command, stdout, stderr io.Writer) {
