...
export const zWorktreeCreatedPayload = z.object({
    head_sha: z.string(),
    id: z.string(),
    owner: z.string(),
    path: z.string(),
 ...
 */
export const zTypedEventStreamEnvelopeWorktreeCreated = z.object({
    actor: z.string(),
    depends_on_step_ids: z.array(z.string()).optional(),
    message: z.string().optional(),
    payload: zWorktreeCreatedPayload,
    run_id: z.string().optional(),
    seq: z.coerce.bigint().gte(BigInt(0)).max(BigInt('9223372036854775807'), { error: 'Invalid value: Expected int64 to be <= 9223372036854775807' }),
    session_id: z.string().optional(),
    step_id: z.string().optional(),
 ...
 */
export const zTypedTaggedEventStreamEnvelopeWorktreeCreated = z.object({
    actor: z.string(),
    city: z.string(),
    depends_on_step_ids: z.array(z.string()).optional(),
    message: z.string().optional(),
...
export const zWorktreePublishedPayload = z.object({
    head_sha: z.string(),
    id: z.string(),
    owner: z.string(),
    path: z.string(),
 ...
 */
export const zTypedEventStreamEnvelopeWorktreePublished = z.object({
    actor: z.string(),
    depends_on_step_ids: z.array(z.string()).optional(),
    message: z.string().optional(),
    payload: zWorktreePublishedPayload,
    run_id: z.string().optional(),
    seq: z.coerce.bigint().gte(BigInt(0)).max(BigInt('9223372036854775807'), { error: 'Invalid value: Expected int64 to be <= 9223372036854775807' }),
    session_id: z.string().optional(),
    step_id: z.string().optional(),
    subject: z.string().optional(),
    ts: z.iso.datetime(),
    type: z.literal('worktree.published'),
    workflow: zWorkflowEventProjection.optional()
});
 ...
 */
export const zTypedTaggedEventStreamEnvelopeWorktreePublished = z.object({
    actor: z.string(),
    city: z.string(),
    depends_on_step_ids: z.array(z.string()).optional(),
    message: z.string().optional(),
...
export const zWorktreeReclaimSkippedPayload = z.object({
    dry_run: z.boolean(),
    head_sha: z.string(),
    id: z.string(),
    owner: z.string(),
 ...
 */
export const zTypedEventStreamEnvelopeWorktreeReclaimSkipped = z.object({
    actor: z.string(),
    depends_on_step_ids: z.array(z.string()).optional(),
    message: z.string().optional(),
    payload: zWorktreeReclaimSkippedPayload,
    run_id: z.string().optional(),
    seq: z.coerce.bigint().gte(BigInt(0)).max(BigInt('9223372036854775807'), { error: 'Invalid value: Expected int64 to be <= 9223372036854775807' }),
    session_id: z.string().optional(),
    step_id: z.string().optional(),
    subject: z.string().optional(),
    ts: z.iso.datetime(),
    type: z.literal('worktree.reclaim_skipped'),
    workflow: zWorkflowEventProjection.optional()
});
 ...
 */
export const zTypedTaggedEventStreamEnvelopeWorktreeReclaimSkipped = z.object({
    actor: z.string(),
    city: z.string(),
    depends_on_step_ids: z.array(z.string()).optional(),
    message: z.string().optional(),
...
export const zWorktreeReclaimedPayload = z.object({
    dry_run: z.boolean(),
    head_sha: z.string(),
    id: z.string(),
    owner: z.string(),
...
export const zEventPayload = z.union([
    ...
    zWorktreeCreatedPayload,
    zWorktreePublishedPayload,
    zWorktreeReclaimSkippedPayload,
    zWorktreeReclaimedPayload
]);
 ...
 */
export const zTypedEventStreamEnvelopeWorktreeReclaimed = z.object({
    actor: z.string(),
    depends_on_step_ids: z.array(z.string()).optional(),
    message: z.string().optional(),
    payload: zWorktreeReclaimedPayload,
    run_id: z.string().optional(),
    seq: z.coerce.bigint().gte(BigInt(0)).max(BigInt('9223372036854775807'), { error: 'Invalid value: Expected int64 to be <= 9223372036854775807' }),
    session_id: z.string().optional(),
    step_id: z.string().optional(),
    subject: z.string().optional(),
    ts: z.iso.datetime(),
    type: z.literal('worktree.reclaimed'),
    workflow: zWorkflowEventProjection.optional()
});
...
export const zTypedEventStreamEnvelope = z.discriminatedUnion('type', [
    ...
    zTypedEventStreamEnvelopeWorktreeCreated.extend({ type: z.literal('worktree.created') }),
    zTypedEventStreamEnvelopeWorktreePublished.extend({ type: z.literal('worktree.published') }),
    zTypedEventStreamEnvelopeWorktreeReclaimSkipped.extend({ type: z.literal('worktree.reclaim_skipped') }),
    zTypedEventStreamEnvelopeWorktreeReclaimed.extend({ type: z.literal('worktree.reclaimed') }),
 ...
 */
export const zTypedTaggedEventStreamEnvelopeWorktreeReclaimed = z.object({
    actor: z.string(),
    city: z.string(),
    depends_on_step_ids: z.array(z.string()).optional(),
    message: z.string().optional(),
...
export const zTypedTaggedEventStreamEnvelope = z.discriminatedUnion('type', [
    ...
    zTypedTaggedEventStreamEnvelopeWorktreeCreated.extend({ type: z.literal('worktree.created') }),
    zTypedTaggedEventStreamEnvelopeWorktreePublished.extend({ type: z.literal('worktree.published') }),
    zTypedTaggedEventStreamEnvelopeWorktreeReclaimSkipped.extend({ type: z.literal('worktree.reclaim_skipped') }),
    zTypedTaggedEventStreamEnvelopeWorktreeReclaimed.extend({ type: z.literal('worktree.reclaimed') }),
