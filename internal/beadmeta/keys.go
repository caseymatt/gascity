...
const (
	AdoptedAtMetadataKey                      = "gc.adopted_at"
	AdoptionActorMetadataKey                  = "gc.adoption_actor"
	AdoptionReasonMetadataKey                 = "gc.adoption_reason"
	AdoptionSourceIDMetadataKey               = "gc.adoption_source_id"
	AdoptionSourceUpdatedAtMetadataKey        = "gc.adoption_source_updated_at"
	AttemptLogMetadataKey                     = "gc.attempt_log"
	AttemptMetadataKey                        = "gc.attempt"
	BondMetadataKey                           = "gc.bond"
	BondVarsMetadataKey                       = "gc.bond_vars"
	BuildFinalReportPathMetadataKey           = "gc.build.final_report_path"
	BuildImplementationSummaryPathMetadataKey = "gc.build.implementation_summary_path"
	BuildPublishActionMetadataKey             = "gc.build.publish_action"
	BuildPublishArtifactPathMetadataKey       = "gc.build.publish_artifact_path"
	BuildPublishedCommitMetadataKey           = "gc.build.published_commit"
	BuildPublishReasonMetadataKey             = "gc.build.publish_reason"
	BuildPublishRemoteStatusMetadataKey       = "gc.build.publish_remote_status"
	BuildPublishStatusMetadataKey             = "gc.build.publish_status"
	...
	ImplementationCommitMetadataKey      = "gc.implementation.commit"
	ImplementationSummaryPathMetadataKey = "gc.implementation.summary_path"
